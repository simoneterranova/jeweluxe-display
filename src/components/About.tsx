      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative reveal opacity-0" style={{ transitionDelay: '300ms' }}>
            ...
            <div className="absolute -bottom-8 -right-8 glass-gold p-6 rounded-xl w-48 reveal opacity-0 shadow-lg" style={{ transitionDelay: '600ms' }}>
              <p className="text-gold font-playfair text-lg font-semibold">Dal 1975</p>
              <p className="text-slate-700">Tradizione orafa italiana</p>
            </div>
          </div>
