...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 relative">
      {/* Gold separator */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" aria-label="Instagram" className="p-2 bg-slate-800/50 hover:bg-gold/20 rounded-full transition-colors">
                <Instagram className="h-5 w-5 text-gold" />
              </a>
              <a href="#" aria-label="Facebook" className="p-2 bg-slate-800/50 hover:bg-gold/20 rounded-full transition-colors">
                <Facebook className="h-5 w-5 text-gold" />
              </a>
              <a href="mailto:info@ravalli-gioielli.it" aria-label="Email" className="p-2 bg-slate-800/50 hover:bg-gold/20 rounded-full transition-colors">
                <Mail className="h-5 w-5 text-gold" />
              </a>
              <a href="tel:0932723553" aria-label="Telefono" className="p-2 bg-slate-800/50 hover:bg-gold/20 rounded-full transition-colors">
